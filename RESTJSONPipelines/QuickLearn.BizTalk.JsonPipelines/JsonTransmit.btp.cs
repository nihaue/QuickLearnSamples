namespace QuickLearn.BizTalk.JsonPipelines
{
    ...
    public sealed class JsonTransmit : Microsoft.BizTalk.PipelineOM.SendPipeline
    {
...
"     <Components>        <Component>          <Name>QuickLearn.BizTalk.JsonEncoder,JsonEncoder, Vers"+
"ion=1.0.0.0, Culture=neutral, PublicKeyToken=bab2a9ea69a59de0</Name>          <ComponentName>JsonEnc"+
"oder</ComponentName>          <Description>Creates output JSON or JSONP from an input XML document</"+
"Description>          <Version>1.0</Version>          <Properties />          <CachedDisplayName>Jso"+
"nEncoder</CachedDisplayName>          <CachedIsManaged>true</CachedIsManaged>        </Component>   "+
"   </Components>    </Stage>  </Stages></Document>";
        
        private const string _versionDependentGuid = "e4daa3ff-954e-4b2d-8af5-5b6741e6a028";
...
"umentSpecTargetNamespaces,TargetCodePage</Value>    </Property>  </Properties></PropertyBag>";
            ...
            IBaseComponent comp1 = Microsoft.BizTalk.PipelineOM.PipelineManager.CreateComponent("QuickLearn.BizTalk.JsonEncoder,JsonEncoder, Version=1.0.0.0, Culture=neutral, PublicKeyToken=bab2a9ea69a59de0");;
